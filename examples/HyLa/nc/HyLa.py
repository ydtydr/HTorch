...
from hype import MODELS, build_model, get_model
...
def main():
    ...
    parser.add_argument('-manifold', type=str, default='PoincareBall',
                        choices=['Euclidean', 'PoincareBall', 'Lorentz', 'HalfSpace'], help='model of hyperbolic space')
    parser.add_argument('-model', type=str, default='hyla',
                        choices=MODELS.keys(), help='feature model class, hyla|rff')
    parser.add_argument('-curvature', type=float, default=-1.0,
                        help='hyperbolic space curvature')
    ...
    optimizer_f = RiemannianSGD(model_f.parameters(), lr=opt.lr_e)
